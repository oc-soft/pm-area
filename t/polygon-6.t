...
sub simple_polygon_1
{
    ...
    $polygons->[0]->freeze;
    my $indices = $polygons->[0]->monotone_triangulation_indices; 
    my @expects = (
        [ 7, 8, 0 ],
        [ 7, 0, 1 ],
        [ 3, 7, 1 ],
    ...
    $test_res = $cmp_res == 0;
    ok($test_res, 'expect success to run monotone_triangulation_indices');
}
...
sub simple_polygon_2
{
    ...
    $polygons->[0]->freeze;
    my $indices = $polygons->[0]->monotone_mountain_triangulation_indices; 
    my @expects = (
        [ 7, 8, 0 ],
        [ 7, 0, 1 ],
        [ 3, 7, 1 ],
    ...
    $test_res = $cmp_res == 0;
    ok($test_res,
        'expect success to run monotone_mountain_triangulation_indices');
}
